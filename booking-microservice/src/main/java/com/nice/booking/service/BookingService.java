...
public class BookingService {
	...
	public Booking create(Booking booking){
		...
		ResponseEntity<Customer> customerEntity = 
				template.getForEntity(customersMicroserviceHost + ":" + customersMicroservicePort + "/customers/" + username, Customer.class);
		...
		ResponseEntity<Car> carEntity = 
				template.getForEntity(carsMicroserviceHost + ":" + carsMicroservicePort + "/cars/" + plateNumber, Car.class);
